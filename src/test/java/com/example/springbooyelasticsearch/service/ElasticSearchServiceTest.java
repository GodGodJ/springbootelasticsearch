...
import com.example.springbooyelasticsearch.SpringbooyelasticsearchApplication;
import com.example.springbooyelasticsearch.model.Order;
...
@SpringBootTest(classes = SpringbooyelasticsearchApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class ElasticSearchServiceTest {
    ...
    public void testDeleteById(){
        elasticSearchService.deteleById("search_index","search_index", order.getId()+"");
    }
